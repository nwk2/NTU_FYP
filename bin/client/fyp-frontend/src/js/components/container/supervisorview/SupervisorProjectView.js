...
class SupervisorProjectView extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            projectdata: null
                    ...
                    <Grid item key={item.project.project_id} xs={12} md={6}>
                        ...
                        <div className={classes.cardDetails}>
                            ...
                            <Typography variant="subtitle1">
                                Assigned Student: {item.user.first_name + " " + item.user.last_name}
                            </Typography>
                            ...
                            <Typography variant="subtitle1" paragraph>
                                Description:<br/>{item.project.project_description}
                            </Typography>
...
export default withStyles(styles)(SupervisorProjectView)